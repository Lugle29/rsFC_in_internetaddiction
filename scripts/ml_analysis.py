...
Adapted to present dataset - see # Specify Tasks
'''
...
def main():
    ...
    # Neuro data - regression
    # Specifiy an analysis name
    ANALYSIS_NAME = 'IAT'
    # Specify path to data. string
    PATH_TO_DATA = 'data/ml_data_prep.xlsx'
    ...
    X_CON_NAMES = [
        ...
        'Precuneus_PCC',
        'Precuneus_dACC',
        'Precuneus_Cerebellum_(L)',
        'Precuneus_Cerebellum_(R)',
        'PCC_dACC',
        'dACC_Cerebellum_(L)',
        'dACC_Cerebellum_(R)',
        'PCC_Cerebellum_(L)',
        'PCC_Cerebellum_(R)',
        'Cerebellum_(L)_Cerebellum_(R)']
    # Specify binary categorical predictor names. list of string or []
    X_CAT_BIN_NAMES = ['gender']
    ...
    TEST_SET_IND = list(randint.rvs(0, 186, size=37))
